public class SimuladorSemaforo {
    public static void main(String[] args) {
        ...
        Carro carro3 = new Carro("Carro 3", 3, semaforo1, semaforo2);
        Carro carro4 = new Carro("Carro 4", 4, semaforo1, semaforo2);
        Carro carro5 = new Carro("Carro 5", 5, semaforo1, semaforo2);
